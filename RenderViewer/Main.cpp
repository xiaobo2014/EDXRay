...
void OnInit(Object* pSender, EventArgs args)
{
	...
	pAreaLight->LoadPlane(2.5f, BSDFType::Diffuse, Color(0.2f), Vector3(2.5f, 4.99f, 0.0f), Vector3::UNIT_SCALE, Vector3(0.0f, 0.0f, 180.0f));
	//pAreaLight->LoadPlane(2.5f, BSDFType::Diffuse, Color(0.2f), Vector3(-3.5f, 9.0f, -3.5f), Vector3::UNIT_SCALE, Vector3(0.0f, -45.0f, 45.0f));
...
void OnRender(Object* pSender, EventArgs args)
{
	...
	EDXGui::BeginScrollableArea(pJobDesc->ImageHeight - 50, contentHeight, scroller);
	{
		...
		auto pEnvLight = dynamic_cast<const EnvironmentLight*>(gpRenderer->GetScene()->GetEnvironmentLight());
